  ...
  <div className="flex-shrink-0 flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
    ...
    <span className="font-semibold">Free Worldwide Shipping</span>
          ...
          <h1 className="font-bold text-5xl md:text-7xl lg:text-8xl text-white mb-8 leading-tight">
            Premium Afro Kinky
            <span className="block text-yellow-300 mt-2">Bulk Hair</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            <button
              ...
              className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white px-20 py-5 rounded-xl font-bold text-xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3 shadow-2xl"
            >
          ...
          <div className="text-white/90 text-center">
            <p className="text-xl mb-4 font-semibold">Trusted by 15,000+ customers worldwide</p>
            <div className="flex justify-center items-center space-x-2">
              {[...Array(5)].map((_, i) => (
                <Star key={i} size={24} className="text-yellow-400 fill-current" />
              ))}
              <span className="ml-3 font-semibold text-lg">Based on 3,247 verified reviews</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-cormorant text-4xl md:text-5xl font-bold text-gray-900 mb-6">Shop by Category</h2>
              ...
              >
                <div className="relative h-48 md:h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="font-cormorant text-lg md:text-xl font-bold text-white mb-2">{category.name}</h3>
                    <p className="text-white/90 text-xs md:text-sm mb-3">{category.description}</p>
