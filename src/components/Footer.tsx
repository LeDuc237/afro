        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button onClick={() => setShowQA(false)} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                ✕
              </button>
            </div>
            <div className="p-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-6 text-gray-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg">1-800-BLEN-HAIR</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg">hello@blenhairs.com</p>
                </div>
              </div>
        ...
        <div className="border-t border-gray-700 mt-16 pt-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 border-t border-gray-700 pt-8">
            <div className="text-lg text-gray-400">© {new Date().getFullYear()} Blen Hairs. All rights reserved.</div>
