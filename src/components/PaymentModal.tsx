    ...
    try {
      ...
      const paymentMethodData = {
        ...
        card: {
          ...
          exp_month: Number.parseInt(formData.expiryDate.split("/")[0]),
          exp_year: Number.parseInt(`20${formData.expiryDate.split("/")[1]}`),
          cvc: formData.cvv,
        },
        billing_details: {
      ...
      <div className="bg-white rounded-3xl max-w-5xl w-full max-h-[95vh] overflow-y-auto shadow-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
          ...
          <div className="order-1 lg:order-2">
            {/* Payment Method Selection - make sure PayPal is always enabled */}
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Test Card Info - Only show for card payments */}
              {paymentMethod === "card" && (
