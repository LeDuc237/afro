          ...
          {displayedProducts.map((product) => (
            ...
            >
              ...
              <div className="p-3 md:p-6">
                ...
                {/* Product Name */}
                <h3 className="font-bold text-gray-900 mb-3 text-xs md:text-lg leading-tight line-clamp-2">
                  {product.name}
                </h3>
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={() => handleProductClick(product.id)}
                    className="flex-1 bg-pink-900 text-white py-2 md:py-3 rounded-lg font-semibold text-xs md:text-base hover:bg-pink-500 transition-colors"
                  >
